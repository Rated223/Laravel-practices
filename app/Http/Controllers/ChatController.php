...
class ChatController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($users as $user) {
            foreach (auth()->user()->Notifications->where('type', 'App\Notifications\ChatSent') as $notification) {
    ...
    {
        $notifications = auth()->user()->Notifications->where('type', 'App\Notifications\ChatSent');
